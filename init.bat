...
if errorlevel == 2 goto :DisableWD
if errorlevel == 1 goto :EnableWD

:EnableWD
@start /b "Calvin - Enable WinDefend - TrustedInstaller" "%~dp0bin\NSudoLG.exe" -U:T -P:E "%~dp0bin\EnableWD.bat"
goto :Start

:DisableWD
@start /b "Calvin - Disable WinDefend - TrustedInstaller" "%~dp0bin\NSudoLG.exe" -U:T -P:E "%~dp0bin\DisableWD.bat"
goto :Start
...
echo.========================================================================================
echo.
echo.	Superfetch is disabled in CB_OS, due to causing high latency issues
echo.	Using Superfetch is only recommended for HDD users
echo.
echo.	Warning: Enabling Superfetch doesn't enable Memory Compression
echo.
echo.	Current State: [%sfStatus%]
echo.	
...
choice /C:12X /N /M "Enter Your Choice: "
if errorlevel == 3 goto :Start
if errorlevel == 2 goto :DisableSF
if errorlevel == 1 goto :EnableSF

:EnableSF
cls
@start /b "Calvin - Enable Superfetch - TrustedInstaller" "%~dp0bin\NSudoLG.exe" -U:T -P:E "%~dp0bin\EnableSF.bat"
goto :Start

:DisableSF
cls
@start /b "Calvin - Disable Superfetch - TrustedInstaller" "%~dp0bin\NSudoLG.exe" -U:T -P:E "%~dp0bin\DisableSF.bat"
goto :Start
...
choice /C:12X /N /M "Enter Your Choice: "
if errorlevel == 3 goto :Start
if errorlevel == 2 goto :WUDriversMode
if errorlevel == 1 goto :WUSettingsMode

:WUSettingsMode
cls
if %wuDwordStatus%==0x1 (
	::unhide
	reg add "HKLM\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\Explorer" /v "SettingsPageVisibility" /t REG_SZ /d "hide:cortana;emailandaccounts;holographic-audio;privacy-automaticfiledownloads;privacy-feedback" /f
...
echo.	
echo.	Press [1] to enable UAC
echo.	Press [2] to disable UAC [Default]
echo.
echo.	Press [X] to return to main menu
echo.
echo.========================================================================================
choice /C:12X /N /M "Enter Your Choice: "
if errorlevel == 3 goto :Start
if errorlevel == 2 goto :DisableUAC
if errorlevel == 1 goto :EnableUAC
...
:Notifications
cls
for /f "tokens=3*" %%i in ('reg query "HKLM\SOFTWARE\Policies\Microsoft\Windows\Explorer" /v "DisableNotificationCenter"') do (
...
echo.
echo.	
echo.	Press [1] to enable Notifications
echo.	Press [2] to disable Notifications (Default)
echo.
echo.	Press [X] to return to main menu
echo.
echo.========================================================================================
...
choice /C:12X /N /M "Enter Your Choice: "
if errorlevel == 3 goto :Start
if errorlevel == 2 goto :DisableITP
if errorlevel == 1 goto :EnableITP
...
echo.========================================================================================
echo.
echo.	From cbergin_OS 10 22.06, FSO became enabled by default as it has
...
choice /C:12X /N /M "Enter Your Choice: "
if errorlevel == 3 goto :Start
if errorlevel == 2 goto :DisableFSO
if errorlevel == 1 goto :EnableFSO
...
choice /C:12X /N /M "Enter Your Choice: "
if errorlevel == 3 goto :Start
if errorlevel == 2 goto :fet11
if errorlevel == 1 goto :rcmenu11
